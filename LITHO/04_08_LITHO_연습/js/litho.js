;(function($){
    ...
    var litho = {
        ...
        section4Fn:function(){
            ...
            console.log('웹문서 전체높이', $(document).height());
        ...
        section7Fn:function(){
            var $contentUl = $('#section7 .content ul');
            var $contentLi = $('#section7 .content ul li');

                bgI = ['url(./img/home-interior-design-services.jpg)',
                       'url(./img/home-interior-design-services-02.jpg)',
                       'url(./img/home-interior-design-services-03.jpg)',
                       'url(./img/home-interior-design-services-04.jpg)'];

            $contentLi.each(function(idx){
                $(this).on({
                    mouseenter:function(){
                        $contentUl.css({backgroundImage:bgI[idx], transition:'all 1s'});
                        $contentLi.removeClass('addEvent');
                        $contentLi.eq(idx).addClass('addEvent');
                    }
                });
            });
            $contentUl.on({
