        ...
        galleryFn:function(){
            ...
            function resizeGalleryFn(){
                ...
                if( btnNum === 0 ){
                    ...
                    // $content.eq(show[0]).addClass('addZoom');
                    // $content.eq(show[1]).addClass('addZoom');
                    // $content.eq(show[2]).addClass('addZoom');
                    // $content.eq(show[3]).addClass('addZoom');
                    // $content.eq(show[4]).addClass('addZoom');
                    // $content.eq(show[5]).addClass('addZoom');
                    // $content.eq(show[6]).addClass('addZoom');
                    // $content.eq(show[7]).addClass('addZoom');
                }
                    ...
                    // $li.eq(hide[1]).stop().hide();
                    // $li.eq(hide[5]).stop().hide();
