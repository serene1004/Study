    ...
    var litho = {
        ...
        section1Fn:function(){
            ...
            function mainPrevSlideFn(){
                $slide.css({zIndex:1}).find('.col').stop().animate({width:50+'%'},0);
                $slide.eq(cnt).css({zIndex:2});
                $slide.eq(cnt===2?0:cnt+1).css({zIndex:3}).find('.col').stop().animate({width:50+'%'},0).animate({width:0},1000);
            }

            function mainNextSlideFn(){
                $slide.css({zIndex:1});
                $slide.eq(cnt===0?2:cnt-1).css({zIndex:2});
                $slide.eq(cnt).css({zIndex:3}).find('.col').stop().animate({width:0},0).animate({width:50+'%'},1000);
            }
