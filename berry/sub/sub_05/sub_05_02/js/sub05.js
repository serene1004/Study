;(function($){
    var sub05_berry = {
        ...
        sub05Fn:function(){
            ...
            var $tBody = $('#section1 .qa-board tbody');
            var $pageBox = $('#section1 .qa-board .page-box ul');
            var $prevBtn = $('#section1 .qa-board .prev-btn');
            var $nextBtn = $('#section1 .qa-board .next-btn');
            var $firstpageBtn = $('#section1 .qa-board .firstpage-btn');
            var $lastpageBtn  = $('#section1 .qa-board .lastpage-btn');
                    ...
                    success:function(result){
                        ...
                        function pageNationFn(){
                            ...
                            if (btn == true) {
                                ...
                                startNum = parseInt($pageBtn.eq(3).text()-1)*list;
                                endNum = startNum+list;
