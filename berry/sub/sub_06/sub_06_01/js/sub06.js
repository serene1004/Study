;(function($){
    var sub06_berry = {
        ...
        sub06Fn:function(){
            ...
            var $tBody = $('#section1 .notice-board tbody');
            var $pageBox = $('#section1 .notice-board .page-box ul');
            var $prevBtn = $('#section1 .notice-board .prev-btn');
            var $nextBtn = $('#section1 .notice-board .next-btn');
            var $firstpageBtn = $('#section1 .notice-board .firstpage-btn');
            var $lastpageBtn  = $('#section1 .notice-board .lastpage-btn');
                    ...
                    success:function(result){
                        ...
                        function listOutputFn(){
                            ...
                            for (var i=startNum; i<endNum; i++) {
                                txt += '<tr>';
                                for (var j=0; j<2; j++) {
                                    txt += '<td>' + a[i][j] + '<a href="#"><i></i><i></i></a></td>';
                                }
                                txt += '</tr>';
                            }
                            $tBody.html(txt);
