;(function($){
    var sub06_berry = {
        ...
        sub06Fn:function(){
            ...
            var $tBody = $('#section1 .reference-board tbody');
            var $pageBox = $('#section1 .reference-board .page-box ul');
            var $prevBtn = $('#section1 .reference-board .prev-btn');
            var $nextBtn = $('#section1 .reference-board .next-btn');
            var $firstpageBtn = $('#section1 .reference-board .firstpage-btn');
            var $lastpageBtn  = $('#section1 .reference-board .lastpage-btn');
