;(function($){
    var sub06_berry = {
        ...
        sub06Fn:function(){
            ...
            var $tBody = $('#section1 .guide-board tbody');
            var $pageBox = $('#section1 .guide-board .page-box ul');
            var $prevBtn = $('#section1 .guide-board .prev-btn');
            var $nextBtn = $('#section1 .guide-board .next-btn');
            var $firstpageBtn = $('#section1 .guide-board .firstpage-btn');
            var $lastpageBtn  = $('#section1 .guide-board .lastpage-btn');
