(function($){
    ...
    $(document).on('click', '.dragdrop-area span > img', function(e){
        ...
        let thisIdNumber = $(e.target).parent().attr('id')

        $('#dragdrop-basebox').append('<span draggable="true" ondragstart="drag(event)" id="drag'+thisIdNumber+'" name="drag">'+thisText+'<img src="./img/icon_del.png" alt=""></span>');
